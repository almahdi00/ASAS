...
$ambil = $koneksi->query("SELECT * FROM tb_pembelian WHERE id_pembelian='$id_pembelian' AND id_pelanggan='{$_SESSION['pelanggan']['id_pelanggan']}'");
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-warning">
      <div class="container">
        <a class="navbar-brand" href="#">Online ShopKU</a>
